...
int main(void)
{
  ...
  /* Re-configure HAL timebase after clock change (TIM1-based, must be started) */
  ...
  MPU_Config();
  LED_Init();
  Usart_SendString(&huart1, "SPI INIT\r\n", 12);
  SPI_LCD_Init();
  Usart_SendString(&huart1, "AFTER SPI\r\n", 11);
